    ...
    <div class="info-container">
        <form>
            ...
            <div class="button-group">
                ...
                <button type="button" class="btn-logout"><i class="fa fa-sign-out"></i><a href="logout.php">Đăng
                        xuất</a></button>
            </div>
        </form>
        <button type="button" class="btn-logout"><i class="fa fa-sign-out"></i><a href="reset_pass.php">Đổi mật khẩu</a></button>
